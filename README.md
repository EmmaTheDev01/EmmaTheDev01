...
* **Frontend & Mobile:** React, React Native, Expo, Next.js, Tailwind CSS
* **Backend & Databases:** Node.js, Laravel, Supabase, Neon DB, PostgreSQL
* **AI & Machine Learning:** Google Gemini APIs, Open-Source LLM Integration, Prompt Engineering
* **Cybersecurity & Infrastructure:** Penetration Testing, SOC Operations, Network Security, Google Cloud Platform (GCP)
* **Tools & Workflow:** VS Code, Git, GitHub Actions, Docker, Postman, KaTeX

---

### 🚀 Projects & Focus

* 🔭 Currently building **[Purelearn.ai](https://purelearn.vigilance.rw)** — an AI-powered Socratic learning workspace built for deep research, document analysis, and rich-text editing.
* 🛡️ Leading **[Vigilance Ltd](https://vigilance.rw)** — developing AI defense tools and providing cybersecurity assessment services.
* 📱 Developing cross-platform mobile and web platforms across fintech, logistics, and education.
* 🤝 Open to collaboration on cybersecurity research, AI applications, and open-source tooling.
...
* **Email:** [emman@vigilance.rw](mailto:emman@vigilance.rw)
